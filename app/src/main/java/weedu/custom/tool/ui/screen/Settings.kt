package weedu.custom.tool.ui.screen
...
import weedu.custom.tool.APApplication
import weedu.custom.tool.BuildConfig
import weedu.custom.tool.Natives
import weedu.custom.tool.R
import weedu.custom.tool.ui.component.SwitchItem
import weedu.custom.tool.ui.component.rememberConfirmDialog
import weedu.custom.tool.ui.component.rememberLoadingDialog
import weedu.custom.tool.ui.theme.refreshTheme
import weedu.custom.tool.util.APatchKeyHelper
import weedu.custom.tool.util.getBugreportFile
import weedu.custom.tool.util.isForceUsingOverlayFS
import weedu.custom.tool.util.isGlobalNamespaceEnabled
import weedu.custom.tool.util.isLiteModeEnabled
import weedu.custom.tool.util.outputStream
import weedu.custom.tool.util.overlayFsAvailable
import weedu.custom.tool.util.rootShellForResult
import weedu.custom.tool.util.setForceUsingOverlayFS
import weedu.custom.tool.util.setGlobalNamespaceEnabled
import weedu.custom.tool.util.setLiteMode
import weedu.custom.tool.util.ui.APDialogBlurBehindUtils
import weedu.custom.tool.util.ui.LocalSnackbarHost
import weedu.custom.tool.util.ui.NavigationBarsSpacer
