package weedu.custom.tool.util
...
import weedu.custom.tool.APApplication.Companion.SUPERCMD
import weedu.custom.tool.BuildConfig
import weedu.custom.tool.apApp
import weedu.custom.tool.ui.screen.MODULE_TYPE
import java.io.File
...
fun listModules(): String {
    ...
    withNewRootShell{
       newJob().add("cp /data/user/*/weedu.custom.tool/patch/ori.img /data/adb/ap/ && rm /data/user/*/weedu.custom.tool/patch/ori.img")
